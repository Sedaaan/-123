...
<body>
    ...
    <script>
        ...
        // Полные описания специальностей
        const specialtyDescriptions = {
            ...
            "ИНФОРМАЦИОННАЯ БЕЗОПАСНОСТЬ": "Защита информации в компьютерных системах, криптография, кибербезопасность. Востребованная специальность в условиях цифровизации экономики.",
